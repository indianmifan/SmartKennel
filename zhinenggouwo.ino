...
//传感器部分================================   
#include <Wire.h>                                  //调用库  
#include "C:\Program Files (x86)\Arduino IDE for Microduino\libraries\_03_m_Module_WIFI\ESP8266.h"
...
#define SSID           "OPPO R9s"                   // cannot be longer than 32 characters!
...
#define DEVICEID   "20400096"
#define PROJECTID "103804"
#define HOST_PORT   (80)
String apiKey="5E7HgZdulMrWbTmXUlhkN9kfXFk=";
char buf[10];
...
//3,传感器值的设置 
float sensor_tem, sensor_hum, sensor_lux, sensor_body;                    //传感器温度、湿度、光照   
char  sensor_tem_c[7], sensor_hum_c[7],sensor_lux_c[7];    //换成char数组传输
String sensor_body_c;
