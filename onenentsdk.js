...
(function(){
    ...
    OneNetApi.prototype = {
        /**
         * 读取设备多个数据流   https://api.heclouds.com/devices/9939133/datapoints?datastream_id=Light,Temperature,Humidity&limit=15
         * */
         ...
         * 获取数据点 cmds
         * */
        getDataPoints: function(deviceId){
            var doneCallBack;
            var uri = 'devices/'+deviceId+'/datapoints?datastreams_id=Light,Temperature,Humidity,&start=2015-01-10T08:00:35';
            var uriComponent = '';
